...
ACLOCAL = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run aclocal-1.11
AMTAR = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
ASCIIDOC = 
AUTOCONF = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run autoconf
AUTOHEADER = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run autoheader
AUTOMAKE = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run automake-1.11
AWK = gawk
CC = gcc -std=gnu99
...
LTLIBOBJS = 
LTVER = 3:0:0
MAKEINFO = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
VERSION = 3.1.0
XMLTO = 
abs_builddir = /ghostcache/pajoseph/github/atomic-zeromq/3.1
abs_srcdir = /ghostcache/pajoseph/github/atomic-zeromq/3.1
abs_top_builddir = /ghostcache/pajoseph/github/atomic-zeromq/3.1
abs_top_srcdir = /ghostcache/pajoseph/github/atomic-zeromq/3.1
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /ghostcache/pajoseph/github/atomic-zeromq/3.1/config/install-sh
